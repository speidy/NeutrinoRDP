...
tbool freerdp_get_fds(freerdp* instance, void** rfds, int* rcount, void** wfds, int* wcount)
{
	rdpRdp* rdp;
...
tbool freerdp_check_fds(freerdp* instance)
{
	int status;
	rdpRdp* rdp;
...
tbool freerdp_shall_disconnect(freerdp* instance)
{
